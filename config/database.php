...
// Function to get soil health status
function getSoilHealthStatus($nitrogen, $phosphorus, $potassium) {
    if ($nitrogen < 20 || $phosphorus < 15 || $potassium < 20) {
        return ['status' => 'danger', 'label' => 'Deficient'];
    } elseif ($nitrogen < 40 || $phosphorus < 30 || $potassium < 40) {
