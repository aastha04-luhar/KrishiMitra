...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <a href="manage_farmers.php"><i class="fas fa-users"></i> Farmer Management</a>
    ...
    <div class="content">
        ...
        <!-- ✅ NEW: Farmer Statistics Cards -->
        <div class="admin-kpi">
            <div class="box" onclick="window.location.href='manage_farmers.php'" style="cursor: pointer;">
                <i class="fas fa-users" style="font-size: 32px; color: #3498db;"></i>
                <h3>Total Farmers</h3>
                <p><?php echo $total_farmers; ?></p>
                <small style="color: #999;">Click to manage</small>
            </div>
            <div class="box" onclick="window.location.href='manage_farmers.php?status=active'" style="cursor: pointer;">
                <i class="fas fa-check-circle" style="font-size: 32px; color: #27ae60;"></i>
                <h3>Active Farmers</h3>
                <p><?php echo $active_farmers; ?></p>
            </div>
            <div class="box" onclick="window.location.href='manage_farmers.php?status=inactive'" style="cursor: pointer;">
                <i class="fas fa-times-circle" style="font-size: 32px; color: #e74c3c;"></i>
                <h3>Inactive Farmers</h3>
                <p><?php echo $inactive_farmers; ?></p>
            </div>
            <div class="box" onclick="window.location.href='manage_farmers.php'" style="cursor: pointer;">
                <i class="fas fa-clock" style="font-size: 32px; color: #f39c12;"></i>
                <h3>Pending Approval</h3>
                <p><?php echo $pending_approval; ?></p>
                <?php if ($pending_approval > 0): ?>
                    <small style="color: #e67e22;">⚠️ Needs attention</small>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="recent-farmers">
            ...
            <?php if (count($recent_farmers) > 0): ?>
                ...
                <div style="text-align: right; margin-top: 15px;">
                    <a href="manage_farmers.php" class="view-all-btn">
                        View All Farmers <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            <?php else: ?>
